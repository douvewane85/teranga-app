            ...
            <nav className="flex-1 px-4 space-y-6">
              ...
              <div>
                ...
                <div className="space-y-1">
                  <Link href="/admin/dashboard" className={`${pathname === "/admin/dashboard" ? "bg-white/10 text-white font-semibold" : "text-[#A3C5B5] hover:bg-white/5 hover:text-white font-normal"} group flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200`}>
              ...
              <div>
                ...
                <div className="space-y-1">
                  <Link href="/admin/members" className={`${pathname.startsWith("/admin/members") && !pathname.includes("memberships") ? "bg-white/10 text-white font-semibold" : "text-[#A3C5B5] hover:bg-white/5 hover:text-white font-normal"} group flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200`}>
                  ...
                  <Link href="/admin/memberships" className={`${pathname.startsWith("/admin/memberships") ? "bg-white/10 text-white font-semibold" : "text-[#A3C5B5] hover:bg-white/5 hover:text-white font-normal"} group flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200`}>
              ...
              <div>
                ...
                <div className="space-y-1">
                  <Link href="/admin/finances/campaigns" className={`${pathname.startsWith("/admin/finances/campaigns") ? "bg-white/10 text-white font-semibold" : "text-[#A3C5B5] hover:bg-white/5 hover:text-white font-normal"} group flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200`}>
                  ...
                  <Link href="/admin/finances/validations" className={`${pathname.startsWith("/admin/finances/validations") ? "bg-white/10 text-white font-semibold" : "text-[#A3C5B5] hover:bg-white/5 hover:text-white font-normal"} group flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200`}>
                  ...
                  <Link href="/admin/finances/history" className={`${pathname.startsWith("/admin/finances/history") ? "bg-white/10 text-white font-semibold" : "text-[#A3C5B5] hover:bg-white/5 hover:text-white font-normal"} group flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200`}>
                  ...
                  <Link href="/admin/finances/debts" className={`${pathname.startsWith("/admin/finances/debts") ? "bg-white/10 text-white font-semibold" : "text-[#A3C5B5] hover:bg-white/5 hover:text-white font-normal"} group flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200`}>
              ...
              <div>
                ...
                <div className="space-y-1">
                  <Link href="/admin/communications" className={`${pathname.startsWith("/admin/communications") ? "bg-white/10 text-white font-semibold" : "text-[#A3C5B5] hover:bg-white/5 hover:text-white font-normal"} group flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200`}>
                  ...
                  <Link href="/admin/reports" className={`${pathname.startsWith("/admin/reports") ? "bg-white/10 text-white font-semibold" : "text-[#A3C5B5] hover:bg-white/5 hover:text-white font-normal"} group flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200`}>
                  ...
                  <Link href="/admin/settings" className={`${pathname.startsWith("/admin/settings") ? "bg-white/10 text-white font-semibold" : "text-[#A3C5B5] hover:bg-white/5 hover:text-white font-normal"} group flex items-center px-3 py-2.5 text-sm rounded-lg transition-all duration-200`}>
