...
function SubmitButton() {
  ...
  return (
    ...
    >
      {pending ? "Création en cours..." : "Créer le membre"}
    </button>
  );
}
...
export default function NewMemberPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Ajouter un nouveau membre</h1>
        <p className="mt-1 text-sm text-gray-500">
          Ce formulaire permet de créer un nouveau compte pour un membre de l'association.
        </p>
      </div>
